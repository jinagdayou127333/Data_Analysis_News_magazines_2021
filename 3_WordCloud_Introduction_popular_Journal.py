...
for label in user_labels['报刊简介']:    #产品分类 #报刊简介 #报刊名称 #把表格的每一列存到列表user_labels_list中
...
wordcloud.to_file('Figures/依据报刊简介的期刊词云.png') #保存图片
...
plt.title('依据报刊简介的期刊前15大词汇')
plt.ylabel('频数',fontsize=12)
plt.xlabel('词汇',fontsize=12)
fig.savefig('Figures/依据报刊简介的期刊前15大词云.png',dpi=300,bbox_inches='tight')