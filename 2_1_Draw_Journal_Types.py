...
nj_j = pd.read_excel('Temp/SelPriceDropYear_Brief_Journal.xlsx')
str_type = nj_j['刊期种类']
...
print(data)
index2=['XunKan','Monthly','Twice Monthly','Bimonthly','Quarterly','Semi-Annual','Twice Weekly','Weekly']
...
# plt.title('期刊种类频次图')
plt.xlabel('Magazines Types',fontsize=12)
fig.savefig('Figures/期刊种类频次图_无年刊2.png',dpi=600,bbox_inches='tight')